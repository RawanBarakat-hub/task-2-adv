export let navItems=[{url:"/",content:"Home"},
    ...
    {url:"/",content:"Admessions"},
    {url:"/",content:"Student Life"},
    {url:"",content:"Contact"}
]
...
export const socialItems=[
        ...
        {
            url:"https://www.google.com/map?q=latakia",
            text:"Somewhere in the World",
            image:{
                source:"/assets/img/icons/location.svg",
                alternative:"location logo"
            }
        }
    ]
...
export let infoFooter=[{
        ...
        title:{url:"/academy",text:"Academics"},
        items:[
        {
            url:"/academy#specialFeatures",
